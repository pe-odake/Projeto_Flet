...
def main(page: ft.Page):
    ...
    slot1 = ft.Container(
        width=70, height=100, left=100, top=0, border=ft.border.all(1)
    )
    ...
    slot3 = ft.Container(
        width=70, height=100, left=100, top=140, border=ft.border.all(1)
    )
    ...
    card1 = ft.GestureDetector(
        ...
        left=0,
        top=0,
        content=ft.Container(ft.Image(src='https://static.dicionariodesimbolos.com.br/upload/8e/29/laranja-1_xl.png'), width=70, height=100),
    )
    ...
    card2 = ft.GestureDetector(
        ...
        left=100,
        top=0,
        content=ft.Container(ft.Image(src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTO4ZphEeeB9b89GJIUydMRgN3H6KNayDbcSQ&s'), width=70, height=100),
    )
    ...
    card3 = ft.GestureDetector(
        ...
        left=100,
        top=0,
        content=ft.Container(ft.Image(src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQqquqrn9JLnm84omZ5XVWIHjtR6_9XCa25Kg&s'), width=70, height=100),
    )

    controls = [slot0, slot1, slot2, slot3, card1, card2, card3]
